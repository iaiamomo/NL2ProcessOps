        ...
        for fs in few_shot:
            ...
            if fs:
                if model == "gpt-3.5-turbo-16k":
                    res_df.to_csv('eval_mod_task_fs_gpt35.csv', sep=',', index=False)
                else:
                    res_df.to_csv('eval_mod_task_fs_gpt4.csv', sep=',', index=False)
            else:
                if model == "gpt-3.5-turbo-16k":
                    res_df.to_csv('eval_mod_task_nfs_gpt35.csv', sep=',', index=False)
                else:
                    res_df.to_csv('eval_mod_task_nfs_gpt4.csv', sep=',', index=False)
